...
const DEFAULT_CONTENT = {
  ...
  concept: {
    visible: true,
    heading: 'あなたの「推し」を\n指先に込めて',
    paragraph1: 'nailsalon Noëlは、横浜・元町中華街エリアにあるネイルサロンです。シンプルなワンカラーからアニメ・ゲーム・アイドルをモチーフにした痛ネイル・キャラクターネイルまで、お客様の「好き」に合わせて幅広くご対応します。',
    paragraph2: '痛ネイルやキャラクターネイルはもちろん、トレンドデザインや大人シンプルネイルも得意です。パラジェル・フィルインにも対応し、爪の健康も大切にした施術を心がけています。',
    ...
    items: [
      {
        ...
        badge: 'クーポン',
        title: '初回限定 20% OFF',
        desc: '初めてのご来店の方限定クーポンです。全メニューでご利用いただけます。お気軽にご来店ください。',
        detail: '全メニュー 20% OFF',
        period: '期間限定',
        url: 'https://beauty.hotpepper.jp/kr/slnH000721618/',
        visible: true
      },
      {
        type: 'flat',
        badge: '定額',
        title: '今月のおすすめプラン',
        desc: '季節のデザインからお選びいただける定額コース。トレンドをおさえたデザインをご用意しています。',
        detail: '¥7,980〜',
        period: '〜2025年6月30日',
        url: '',
        visible: true
    ...
    members: [
      ...
      },
      {
        ...
        designs: [
          ...
          { url: 'images/staff/designs/kureka-2.jpg', label: '痛ネイル' },
          { url: 'images/staff/designs/kureka-3.jpg', label: '3Dアート' },
          { url: 'images/staff/designs/kureka-4.jpg', label: '3Dニュアンス' },
...
function loadContent() {
  try {
    ...
    if (saved) {
      ...
      // バージョンが古い場合、配列フィールドをデフォルトにリセット
      if (!parsed._v || parsed._v < CONTENT_VERSION) {
        if (parsed._v < 2) {
